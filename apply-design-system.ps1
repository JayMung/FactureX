...
foreach ($file in $files) {
    ...
    if ($count -gt 0) {
        ...
        Write-Host "✅ $($file.Name): $count remplacement(s)" -ForegroundColor Green
    }
}
...
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""
Write-Host "ℹ️  Les couleurs emerald ont été remplacées par green" -ForegroundColor Cyan
Write-Host "⚠️  Vérifiez que tout fonctionne correctement avec npm run dev" -ForegroundColor Yellow
