/**
 * API Endpoint: GET /v1/api-clients
 * Returns filtered client data for external integrations
 * 
 * Versioned routes:
 *   GET /v1/api-clients   — current (recommended)
 *   GET /api-clients       — legacy (deprecated, supported until 2026-06-01)
 */
...
const FUNCTION_NAME = 'api-clients';
