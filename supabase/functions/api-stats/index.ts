/**
 * API Endpoint: GET /v1/api-stats
 * Returns dashboard statistics for external integrations
 * 
 * Versioned routes:
 *   GET /v1/api-stats   — current (recommended)
 *   GET /api-stats       — legacy (deprecated, supported until 2026-06-01)
 */
